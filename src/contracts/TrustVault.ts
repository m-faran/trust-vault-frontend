...
export type TrustVaultComposer<TReturns extends [...any[]] = []> = {
  ...
  * Get vault information for a Vault User.
   ...
   */
  simulate(): Promise<TrustVaultComposerResults<TReturns> & { simulateResponse: SimulateResponse }>
  simulate(options: SkipSignaturesSimulateOptions): Promise<TrustVaultComposerResults<TReturns> & { simulateResponse: SimulateResponse }>
  simulate(options: RawSimulateOptions): Promise<TrustVaultComposerResults<TReturns> & { simulateResponse: SimulateResponse }>
  /**
